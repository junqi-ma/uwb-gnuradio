...
%
%   This script is the generator of record.  When MATLAB is unavailable,
%   testdata/uwb_radar/generate_uwb_radar_golden.py splices 4z2 onto the
%   existing IEEE-SFD packet and writes the same filenames.
    ...
    meta = struct();
    meta.description = ['UWB monostatic-radar golden from lrwpanWaveformGenerator: ', ...
        'code 9, 64 SYNC, 4z2 SFD, 998.4 MS/s + one-shot 48/65 native.'];
    ...
    meta.cir.demod_8_30 = struct('pre', cirDemodPre, 'post', cirDemodPost, ...
        ...
        'note', 'delay_int peak at pre+37 is outside post=30');
    meta.files = struct( ...
    ...
    meta.note = ['MATLAB lrwpanWaveformGenerator is the generator of record. ', ...
        'Python generate_uwb_radar_golden.py splices 4z2 onto the existing IEEE-SFD packet.'];
