...
BOOST_AUTO_TEST_CASE(test_sc16_fixed_capture_and_bit_exact_pdu)
{
    ...
    // Default production host rate when sample_rate is omitted.
    BOOST_CHECK_CLOSE(
...
BOOST_AUTO_TEST_CASE(test_sc16_sample_rate_metadata)
{
    ...
    constexpr size_t capture = 5000;
    constexpr size_t packet_start = 7000;
    constexpr double kCustomRate = 555000000.0;
