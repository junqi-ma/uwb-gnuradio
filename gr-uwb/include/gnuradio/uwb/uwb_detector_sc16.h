 ...
 *
 * UwbDetectorSc16 — message/PDU UWB packet detection block.
 *
...
class UWB_API UwbDetectorSc16 : public gr::sync_block
{
public:
    using sptr = std::shared_ptr<UwbDetectorSc16>;
    ~UwbDetectorSc16() override;

    /**
     * Make a new UwbDetectorSc16 block.
     *
...
protected:
    UwbDetectorSc16(const std::vector<std::complex<float>>& known_preamble,
                size_t pre_trigger,
                size_t capture,
...
private:
    ...
    std::array<UwbDetectorStateMachineSc16::RegionHandle,
               UwbDetectorStateMachineSc16::kRegionPoolSize> d_job_queue{};
